...
See `commands/status.md` for the full output format and detection logic.

## When this skill fires

- User runs `/status` directly
...
- `<config-root>/briefs/` directory listing (briefing usage signal, optional)
